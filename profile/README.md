...
| [solrengine-auth](https://github.com/solrengine/solrengine-auth) | SIWS wallet authentication |
| [solrengine-rpc](https://github.com/solrengine/solrengine-rpc) | Solana JSON-RPC client |
| [solrengine-tokens](https://github.com/solrengine/solrengine-tokens) | Token metadata + portfolio via Jupiter |
| [solrengine-transactions](https://github.com/solrengine/solrengine-transactions) | SOL transfers + confirmation tracking |
| [solrengine-realtime](https://github.com/solrengine/solrengine-realtime) | WebSocket monitoring + Turbo Streams |
